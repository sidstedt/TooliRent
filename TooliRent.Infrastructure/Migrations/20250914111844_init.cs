    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), "ROLE-CONC-ADMIN", "Admin", "ADMIN" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), "ROLE-CONC-MEMBER", "Member", "MEMBER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, true, "Borrmaskiner" },
                    { 2, null, true, "Skruvdragare" },
                    { 3, null, true, "Handverktyg" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingItems_BookingId_ToolId",
                table: "BookingItems",
